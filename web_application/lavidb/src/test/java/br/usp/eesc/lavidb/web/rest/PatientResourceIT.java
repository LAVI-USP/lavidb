...
class PatientResourceIT {
    ...
    void createPatient() throws Exception {
        ...
        assertThat(testPatient.getHash()).isEqualTo(DEFAULT_HASH);
    }
    ...
    void putExistingPatient() throws Exception {
        ...
        updatedPatient.name(UPDATED_NAME).sex(UPDATED_SEX).birthDate(UPDATED_BIRTH_DATE).age(UPDATED_AGE).hash(UPDATED_HASH);
        ...
        assertThat(testPatient.getHash()).isEqualTo(UPDATED_HASH);
    }
    ...
    void partialUpdatePatientWithPatch() throws Exception {
        ...
        partialUpdatedPatient.name(UPDATED_NAME).sex(UPDATED_SEX).birthDate(UPDATED_BIRTH_DATE).age(UPDATED_AGE);
    ...
    void fullUpdatePatientWithPatch() throws Exception {
        ...
        partialUpdatedPatient.name(UPDATED_NAME).sex(UPDATED_SEX).birthDate(UPDATED_BIRTH_DATE).age(UPDATED_AGE).hash(UPDATED_HASH);

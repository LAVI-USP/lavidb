...
import { EntityArrayResponseType, CustomUserService } from '../service/custom-user.service';
...
export class CustomUserComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICustomUser): number => this.customUserService.getCustomUserIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.customUsers = this.refineData(dataFromBody);
  }

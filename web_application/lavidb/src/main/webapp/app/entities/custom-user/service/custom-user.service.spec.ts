...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../custom-user.test-samples';

import { CustomUserService } from './custom-user.service';

const requireRestSample: ICustomUser = {

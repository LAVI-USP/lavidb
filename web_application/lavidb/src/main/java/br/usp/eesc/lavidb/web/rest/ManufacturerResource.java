...
/**
 * REST controller for managing {@link br.usp.eesc.lavidb.domain.Manufacturer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Manufacturer> partialUpdateManufacturer(
        ...
        Optional<Manufacturer> result = manufacturerRepository
            ...
            .map(existingManufacturer -> {
                ...
                if (manufacturer.getModel() != null) {
                    existingManufacturer.setModel(manufacturer.getModel());
                }
                if (manufacturer.getModality() != null) {
                    existingManufacturer.setModality(manufacturer.getModality());
                }
                if (manufacturer.getHash() != null) {
                    existingManufacturer.setHash(manufacturer.getHash());
                }
